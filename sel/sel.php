							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <p><a href="addsel.php" class="btn btn-success"><i class="glyphicon-plus"></i> &nbsp;Add Seller</a>&nbsp;
...
checkboxes[i].checked = source.checked;
						...
						<?php
							include('../connect.php');
							$result = mysqli_query($conn, "SELECT * FROM packer WHERE adminusername = '$student'");
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td><div align="center"> <a rel="tooltip"  title="Edit" href="editsel.php?id='.$row['id'].'" class="btn btn-success">Edit</a> <br><br></div></td>';
									echo '</tr>';
								}
							?> 
                            </tbody>
