...
?>
<form action="execeditsel.php" method="post">
	<input type="hidden" name="id" value="<?php echo $id=$_GET['id'] ?>" />
  Username:<br><input name="Username" type="text" class="ed" id="Username" value="<?php echo $Username ?>"><br>
	Password:<br><input name="Password" type="password" class="ed" id="Password" value="<?php echo $Password ?>"><br>
